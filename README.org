...
(use-package hydra
  ...
  (defhydra hydra-launcher (:color blue)
    ...
    ("s" shell "shell")
    ("q" nil "cancel"))
  (global-set-key (kbd "C-M-z r") 'hydra-launcher/body))
...
(bind-keys
 ...
 ("C-M-z b s" . shell)
 ("C-M-z b e" . eshell)
 ("C-M-z b v" . eval-buffer)
 ("C-M-z b k" . kill-buffer-and-window)
 ("C-x K" . kill-this-buffer)

 ;; Custom defuns
 ("C-M-z f d" . xah-delete-current-file-make-backup)

 ;; Orafunctions
 ("C-M-z o w" . ora-open-wikipedia)
...
;; (global-set-key (kbd "C-M-z w p") 'windmove-up)
;; (global-set-key (kbd "C-M-z w n") 'windmove-down)
;; (global-set-key (kbd "C-M-z w f") 'windmove-right)
;; (global-set-key (kbd "C-M-z w b") 'windmove-left)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  ;; ;; The example shorten 'C-M-z q' to 'C-q'.
  ...
  ;; ;; C-M-z, C-x are needed for copying and pasting
  ;; (delete ?\C-x exwm-input-prefix-keys)
  ;; (delete ?\C-M-z exwm-input-prefix-keys)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'company
    (company-quickhelp-mode)
    (define-key company-active-map (kbd "C-M-z c q") #'company-quickhelp-manual-begin))
...
#+begin_src emacs-lisp :tangle yes
  ...
  (use-package auto-yasnippet
    ...
    :bind (("C-M-z y a" . aya-create)
           ("C-M-z y e" . aya-expand)
           ("C-M-z y o" . aya-open-line)))
#+end_src
...
#+begin_src emacs-lisp :tangle yes
    (use-package smartparens-config
      ...
      :bind
      ("C-M-z s f o" . sp-forward-sexp)
      ("C-M-z s B" . sp-backward-sexp)
      ("C-M-z s b u" . sp-backward-up-sexp)
      ("C-M-z s b d" . sp-backward-down-sexp)
      ("C-M-z s b e" . sp-beginning-of-sexp)
      ("C-M-z s e n" . sp-end-of-sexp)
      ("C-M-z s d o" . sp-down-sexp)
      ("C-M-z s u p" . sp-up-sexp)
      ("C-M-z s n" . sp-next-sexp)
      ("C-M-z s p" . sp-previous-sexp)
      ("C-M-z s k" . sp-kill-sexp)
      ("C-M-z s c" . sp-copy-sexp)
      ("C-M-z s u n" . sp-unwrap-sexp)
      ("C-M-z s u b" . sp-backward-unwrap-sexp)
      ("C-M-z s f s" . sp-forward-slurp-sexp)
      ("C-M-z s f b" . sp-forward-barf-sexp)
      ("C-M-z s b s" . sp-backward-slurp-sexp)
      ("C-M-z s b b" . sp-backward-barf-sexp)
      ("C-M-z s s p" . sp-splice-sexp)
      ("C-M-z s s b" . sp-splice-sexp-killing-backward)
      ("C-M-z s s k" . sp-splice-sexp-killing-around)
      ("C-M-z s s n e" . sp-select-next-thing-exchange)
      ("C-M-z s s n t" . sp-select-next-thing)
      ("C-M-z s m" . sp-mark-sexp)
      ("C-M-z s f S" . sp-forward-symbol)
      ("C-M-z s b S" . sp-backward-symbol))

    (use-package emacs-surround
      :ensure nil
      :bind ("C-M-z d q" . emacs-surround))
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package move-text
    :bind
    ("C-M-z d m u" . move-text-bup)
    ("C-M-z d m d" . move-text-down))
  ...
  (use-package goto-chg
    :bind
    ("C-M-z d g a" . goto-last-change)
    ("C-M-z d g r" . goto-last-change-reverse))
  ...
  ;;   :bind ("C-M-z d o" . origami-toggle-node))
  ...
  (use-package mark-multiple
    :bind ("C-M-z d n" . 'mark-next-like-this))
  ...
  (use-package dumb-jump
    ...
    :bind (("C-M-z t d g" . dumb-jump-go)
           ("C-M-z t d b" . dumb-jump-back)
           ("C-M-z t d q" . dumb-jump-quick-look)))
...
#+begin_src emacs-lisp :tangle yes
  ...
  ;;   :bind
  ;;   (:map global-map
  ;;         ("C-M-z x t t"      . treemacs-toggle)
  ;;         ("C-M-z x t s"      . treemacs-select-window)
  ;;         ("C-M-z x t d"      . treemacs-delete-other-windows)
...
(use-package emms
  ...
  :bind
  ("C-M-z x e a" . emms)
  ("C-M-z x e b" . emms-smart-browse)
  ("C-M-z x e u" . emms-player-mpd-update-all-reset-cache)
  ("C-M-z x e c" . emms-playlist-clear)
  ("C-M-z x e S" . emms-start)
  ("C-M-z x e r" . emms-toggle-repeat-track)
  ("C-M-z x e p" . emms-previous)
  ("C-M-z x e n" . emms-next)
  ("C-M-z x e P" . emms-pause)
  ("C-M-z x e U" . mpd-update-database)
  :init
...
#+begin_src emacs-lisp :tangle yes
  ...
  (use-package define-word
    ...
    :diminish
    :bind
    ("C-M-z x d w" . define-word)
    ("C-M-z x d a" . define-word-at-point))
...
(use-package engine-mode
  :config
  (engine/set-keymap-prefix (kbd "C-M-z t e"))
...
(use-package crux
  :defer 2
  :diminish
  ;; :bind (("C-M-z o" . crux-open-with)
  ;;        ("M-o" . crux-smart-open-line)
  ;;        ("C-M-z n" . crux-cleanup-buffer-or-region)
  ;;        ("C-M-z f" . crux-recentf-ido-find-file)
  ;;        ("C-M-z" . crux-indent-defun)
  ;;        ("C-M-z u" . crux-view-url)
  ;;        ("C-M-z e" . crux-eval-and-replace)
  ;;        ("C-M-z w" . crux-swap-windows)
  ;;        ("C-M-z D" . crux-delete-file-and-buffer)
  ;;        ("C-M-z r" . crux-rename-buffer-and-file)
  ;;        ("C-M-z t" . crux-visit-term-buffer)
  ;;        ("C-M-z k" . crux-kill-other-buffers)
  ;;        ("C-M-z TAB" . crux-indent-rigidly-and-copy-to-clipboard)
  ;;        ("C-M-z I" . crux-find-user-init-file)
  ;;        ("C-M-z S" . crux-find-shell-init-file)
  ...
  ;;        ("C-M-z s" . crux-ispell-word-then-abbrev))
  )
...
(use-package restart-emacs
  ...
  :diminish
  :bind
  ("C-M-z x r" . restart-emacs)
  ("C-M-z x R" . restart-emacs-restore-frames))
...
;; :diminish
;; :init (persp-mode +1)
;; :bind ("C-M-z x p" . persp-switch-last)
;; :config
...
;; :defer 2
;; :diminish
;; :bind ("C-M-z x P" . projectile-persp-switch-project))
...
(use-package org
  ...
  :bind ("C-M-z c" . org-capture)
  ("C-M-z l" . org-store-link)
  ("C-M-z a" . org-agenda)
  ("C-M-z b" . org-switchb)
  :config
  ;; (define-key global-map "\C-M-zl" 'org-store-link)
  ;; (defbine-key global-map "\C-M-za" 'org-agenda)
  (setq org-log-done t)
...
;; (define-key global-map "\C-M-zc" 'org-capture)
...
;; (global-set-key (kbd "C-M-z y") 'yank-to-x-clipboard)
